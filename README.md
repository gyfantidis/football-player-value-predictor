...
technical_report.md 5-page conference-style report
presentation.md     Marp slide deck (9 slides, ~5 min)
presentation.pdf    rendered slides (PDF)
presentation.pptx   rendered slides (PowerPoint)
```
...
| File | Description |
|---|---|
| [technical_report.md](technical_report.md) | 5-page technical report (conference format) |
| [presentation.pdf](presentation.pdf) | 5-minute slide deck (PDF) |
| [presentation.pptx](presentation.pptx) | 5-minute slide deck (PowerPoint) |
